...
*
*
*  Filename:			combined_bringup_launch.py
*  Author:			    Tahsin Khan 
*  
*****************************************************************************************
'''
...
def generate_launch_description():
    ...
    ackermann_rc_nav2_dir = get_package_share_directory('ackermann_rc_nav2')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(ackermann_rc_nav2_dir, 'maps', 'map.yaml'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(ackermann_rc_nav2_dir, 'params', 'nav2_params.yaml'),
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(ackermann_rc_nav2_dir, 'config', 'mapper_params_online_async.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(ackermann_rc_nav2_dir, 'rviz', 'nav2_default_view.rviz'),
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[os.path.join(ackermann_rc_nav2_dir, 'config/ekf.yaml'), {'use_sim_time': use_sim_time}]
    )
